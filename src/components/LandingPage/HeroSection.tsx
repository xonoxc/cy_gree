		...
		>
			...
			<div className="container flex  justify gap-2 flex-col md:flex-row md:h-screen">
				<div className="intro flex items-center  md:py-52 flex-col">
					...
					<BoxReveal boxColor="green">
						<p className="text-xl dark:text-gray-300 text-gray-600 mb-8">Join our mission to create a cleaner environment and earn rewards for your efforts!</p>
					</BoxReveal>
					<BoxReveal boxColor="green">
						<RainbowButton className="font-bold flex items-center justify-center gap-2" onClick={() => router.push("/auth/sign-up")}>
							Get Started
							<MoveRight size={14} />
						</RainbowButton>
					</BoxReveal>
